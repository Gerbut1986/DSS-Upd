namespace DSS.BLL.DTO
{
    ...
    public class Not_WSIBs_DTO : Interfaces.IModel
    {
        string[] locNames;
        public Not_WSIBs_DTO() => locNames = STREAM.GetLocNames().ToArray();
        ...
        {
            return $"{locNames[Location - 1]},{Date_of_Incident},{Employee_Initials},{Position},{Time_of_Incident},{Shift},{Home_Area},{Injury_Related}," +
